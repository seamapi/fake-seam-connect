...
test("POST /thermostats/update_climate_preset with api key", async (t) => {
  ...
  t.is(deviceProps.current_climate_setting?.climate_preset_key, "testpresett");
